...
<section class="container" style="margin-top: 130px">
  <hr>
  <h3>Example - 5</h3>
  <p style="margin-bottom: 30px">Without Refresh Page (Use <code>page_loaded</code> and <code>background_response</code> custom key)</p>
  <hr>
    ...
    if (name.val().trim().length === 0) {
      ...
      setTimeout(function() {
        if (Math.floor(Math.random() * 2) === 1) {
          alert("Data has been successful saved. Record ID: "+ Math.floor(Math.random() * 1000));
          // window.location.href = "http://localhost/_Core_PHP/Excel-Data-Fill-Extension/example-5.php"
        } else {
